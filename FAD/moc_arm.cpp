...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Arm_t, stringdata) + ofs \
...
const QMetaObject Arm::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_Arm.data,
...
void *Arm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Arm.stringdata))
