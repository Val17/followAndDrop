...
#include "../../FollowAndDrop/target.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Target_t, stringdata) + ofs \
...
const QMetaObject Target::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_Target.data,
...
void *Target::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Target.stringdata))
